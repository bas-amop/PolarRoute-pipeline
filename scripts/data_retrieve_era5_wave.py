...
output_dir = pipeline_directory + "/datastore/wave/era5/daily/"
...
# Loop through most recent three days of data and download wave variables
for i in range(3):
    ...
    output_file = output_dir + f"era5_wave_{date_str}.nc"

    # Check for existing file
    if os.path.isfile(output_file):
        print(f"Wave data file for {date_str} already exists: {output_file}")
        continue
    ...
    try:
        c.retrieve(
            'reanalysis-era5-single-levels',
            {
                ...
                'variable': [
                    'maximum_individual_wave_height', 'mean_wave_direction', 'mean_wave_period',
        ...
        print(f"Unable to retrieve wave data file for {date_str}: {output_file}")
        print(str(e))
